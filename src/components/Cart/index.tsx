  ...
  return (
    <CartContainer className={isOpen ? 'is-open' : ''}>
      ...
      <Sidebar className={purchaseData ? '' : 'is-closed'}>
        ...
        <Button className="firstButton" type="button" onClick={goToPayment}>
      ...
      <Sidebar className={paymentData ? '' : 'is-closed'}>
        ...
        <form onSubmit={form.handleSubmit}>
          ...
          <Button type="submit" className="firstButton" onClick={goToCheckout}>
            Finalizar pagamento
          </Button>
      ...
      {isSuccess ? (
        ...
        <Sidebar className={checkout ? '' : 'is-closed'}>
          <h3 className="errorzin">Carregando...</h3>
        </Sidebar>
      )}
    </CartContainer>
  )
